...
<div class="d-flex flex-column">
    <div class="justify-content-center row my-1 mb-2 mx-1 ">
        ...
        <div class="bg-secondary col-md-4 col-12 rounded my-1 mx-1 ">
            ...
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis nesciunt itaque dicta, fugit, nihil id similique corporis deleniti necessitatibus, eum placeat eos sunt illo officia cum alias eveniet sapiente maiores.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem esse ratione molestiae illum. Maxime totam fuga officia similique harum ipsa blanditiis nostrum, nulla mollitia asperiores minima ipsam aliquam vero sed.</p>
        </div>
